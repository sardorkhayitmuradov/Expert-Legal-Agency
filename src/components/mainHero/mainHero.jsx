      ...
      <div className="hero-left">
        ...
        <div className="hero-left__process">
          <div className="hero--left__items">
            ...
            <p className="hero-left__items__desc">для получения наследства</p>
          </div>
          <div className="hero--left__items">
            <img src={iconThomb} alt="" className="hero-left__items__iamge" />
            <p className="hero-left__items__desc">для получения наследства</p>
        ...
        <p className="hero-left__p">
          Оформление и выдача электронного отчета об оценке полностью онлайн по
          минимальной цене и самым удобным способом в России. Местонахождение
          наследников и нотариуса не имеет значения.
        </p>
        <div className="btns">
